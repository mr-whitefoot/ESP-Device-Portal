...
|-----------------|---------|--------------------|--------|-----------------|
| `esp01_relay`   | ESP-01  | Реле               | 4.4.1  | GPIO0           |
| `d1_mini_relay` | D1 mini | Реле               | 4.4.1  | D1 (GPIO5)      |
| `esp07s_relay8` | ESP-07S | 8 реле             | 4.4.1  | 16,14,12,13,15,0,4,5 |
| `esp01_ds18b20` | ESP-01  | Датчик температуры | 4.4.1  | GPIO2 (OneWire) |
| `d1_mini_ds18b20` | D1 mini | Датчик температуры | 4.4.1 | D2 (GPIO4, OneWire) |
...
- **Лог с уровнями** — в Serial и на страницу `/log` портала, читается и
  ...
  ```text
  [    0.043] I boot start Relay v4.4.1 built=10.08.2026
...
```
.pio/build/esp01_relay/ESP_Relay_v4.4.1.bin
.pio/build/d1_mini_relay/ESP_Relay_D1_mini_v4.4.1.bin
.pio/build/esp07s_relay8/ESP_Relay_ESP07S_8ch_v4.4.1.bin
.pio/build/esp01_ds18b20/ESP_DS18B20_v4.4.1.bin
.pio/build/d1_mini_ds18b20/ESP_DS18B20_D1_mini_v4.4.1.bin
```
...
Тег вида `version_4.4.1` дополнительно собирает прошивки заново и публикует их
