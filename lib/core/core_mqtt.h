...
// убранное. Поведение перезагрузки и factory reset здесь намеренно не меняем
// (см. пункт 28 в HANDOFF): прежнее имя переживает перезагрузку в настройках,
// а снимаем мы его топики здесь, когда завещание давно отработало.
//
